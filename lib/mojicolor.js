...
function convertColorToHex(color) {
    const 
        jp_colors = path.join(__dirname,"../data/jp_colors.json"),
        intl_colors = path.join(__dirname,"../data/intl_colors.json"),
        metro_colors = path.join(__dirname,"../data/metro_colors.json"),
        rail_colors = path.join(__dirname,"../data/rail_colors.json"),
        colorsData = [jp_colors,intl_colors,metro_colors,rail_colors];

    
    for (const i of colorsData ) {
        const 
            colors = JSON.parse(fs.readFileSync(i, 'utf-8')),
